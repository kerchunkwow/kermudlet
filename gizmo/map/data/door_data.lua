doorData = {
  ...
  [343] = {
    north = {
      exitDescription = "A large, magnificent house meets your steady gaze. Above the round door a sign reads 'Bag End'.",
      exitDest = 344,
      exitKeyword = "door"
    }
  },
  ...
  [1325] = {
    down = {
      exitDescription = "There seems to be a handle on the top though you can't figure out why you didn't see it before.",
      exitDest = 1332,
      exitKeyword = "trapdoor"
    }
  },
